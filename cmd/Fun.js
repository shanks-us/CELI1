...
ovlcmd(
    ...
    async (ms_org, ovl, cmd_options) => {
        ...
        const message = `╭───🏆 *CELIBATAIRE-RANK* 🏆───╮
┃ 🏷️ *Nom :* ${name || "Inconnu"}
┃ 🥇 *Classement :* ${rankPosition}/${totalUsers}
┃ 🔰 *Niveau :* ${level}
┃ 🏅 *Titre :* ${levels[level - 1]?.name || "CELIBATAIRE-GOD-LEVEL"} 
